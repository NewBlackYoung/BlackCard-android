...
import com.sainti.blackcard.housekeeperorder.bean.HousekeeperDetailBean;
...
public class HkOrderDetailActivity extends BaseTitleActivity implements OnNetResultListener, View.OnClickListener, PopupWindow.OnDismissListener, Malipay.OnAlipayListener, TimerListener {
    ...
    private HousekeeperDetailBean housekeeperDetailBean;
    private View bg;
    ...
    public int setLayout() {
        return R.layout.activity_hk_order_detail;
    }
    ...
    protected void initData() {
        ...
        loadingView.show();
        TurnClassHttp.guanjiaorderdetail(id, 1, this, this);
        downPopupWindow();
    ...
    public void onSuccessfulListener(String stringResult, int resultCode) {
        ...
        switch (resultCode) {
            case 1:
                housekeeperDetailBean = gson.fromJson(stringResult, HousekeeperDetailBean.class);
                if (housekeeperDetailBean.getResult().equals("1")) {
                    add_time.setText(housekeeperDetailBean.getData().getAdd_time());
                    creater_user.setText(housekeeperDetailBean.getData().getCreater_user());
                    product_type_name.setText(housekeeperDetailBean.getData().getProduct_type_name());
                    tv_product_name.setText(housekeeperDetailBean.getData().getProduct_name());
            ...
            case 5:// 余额支付
                ...
                if (pinganBean != null && pinganBean.getResult().equals("1")) {
                    Intent intent = new Intent(HkOrderDetailActivity.this, PingAnPayWebView.class);
    ...
    private void showDialog() {
        ...
        tv_deleteSure.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TurnClassHttp.delguanjiaorder(housekeeperDetailBean.getData().getOrder_id(), 2, HkOrderDetailActivity.this, HkOrderDetailActivity.this);
                dialog.dismiss();
                loadingView.show();
    ...
    private void downPopupWindow() {
        ...
        lay_weixin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                loadingView.show();
                TurnClassHttp.getApporder(a + "", orderId, product_name, "android", ConvertUtil.getTime(), 3, HkOrderDetailActivity.this, HkOrderDetailActivity.this);
        ...
        lay_zhifubao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                loadingView.show();
                TurnClassHttp.getHaoWuDanHao(product_name, product_name, orderId, lastPrice, 4, HkOrderDetailActivity.this, HkOrderDetailActivity.this);
    ...
    private void yueZhifu() {
        loadingView.show();
        TurnClassHttp.pingan_pay(orderId, 5, this, this);
    }
    ...
    public void Event(NormalEventBean messageEvent) {
        ...
        if (messageEvent.getMessageCode().equals("-2")) {
            Toast.makeText(HkOrderDetailActivity.this, "支付失败", Toast.LENGTH_LONG).show();
        }
        // 支付失败
    ...
    public void onCancel() {
        ...
        Toast.makeText(HkOrderDetailActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
    }
