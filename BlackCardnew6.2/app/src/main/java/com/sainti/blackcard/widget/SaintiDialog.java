 ...
 * 
 */
public class SaintiDialog extends Dialog implements OnClickListener,
        TextWatcher {
	...
	public SaintiDialog(Context context, int theme) {
		super(context, theme);
	}
	...
	public static SaintiDialog createDialog(Context context) {
		...
		//viewxian = (View) sSaintiDialog.findViewById(R.id.viewxian);
	...
	public void setButtonOne(String btnString2) {
