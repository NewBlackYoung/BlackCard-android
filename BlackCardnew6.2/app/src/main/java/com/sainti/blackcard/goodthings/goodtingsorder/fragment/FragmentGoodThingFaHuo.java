...
public class FragmentGoodThingFaHuo extends BaseFragment implements OnRefreshListener, OnLoadmoreListener, OnNetResultListener, BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.OnItemChildClickListener, View.OnClickListener {
    ...
    protected int setLayout() {
        return R.layout.fragment_goodthingsfahuo;
    }
    ...
    protected void initData() {
        ...
        TurnClassHttp.haowuorder("yfh", "1", 1, context, this);
    ...
    public void onLoadmore(RefreshLayout refreshlayout) {
        page++;
        loadingView.dismiss();
        TurnClassHttp.haowuorder("yfh", String.valueOf(page), 2, context, this);
    }
