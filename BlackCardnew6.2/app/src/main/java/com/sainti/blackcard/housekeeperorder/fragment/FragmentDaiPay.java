...
public class FragmentDaiPay extends BaseFragment implements OnRefreshListener, OnLoadmoreListener, OnNetResultListener, BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.OnItemChildClickListener, TimerListener, PopupWindow.OnDismissListener, Malipay.OnAlipayListener {
    ...
    private void showDialog(final int p) {
        ...
        tv_deleteSure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TurnClassHttp.delguanjiaorder(list.get(p).getOrder_id(), 3, context, FragmentDaiPay.this);
                dialog.dismiss();
    ...
    private void downPopupWindow() {
        ...
        lay_yue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                loadingView.show();
                TurnClassHttp.pingan_pay(orderId, 6, context, FragmentDaiPay.this);
            }
        });
        lay_weixin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                loadingView.show();
                TurnClassHttp.getApporder(a + "", orderId, product_name, "android", ConvertUtil.getTime(), 4, context, FragmentDaiPay.this);
        ...
        lay_zhifubao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                loadingView.show();
                TurnClassHttp.getHaoWuDanHao(product_name, product_name, orderId, lastPrice, 5, context, FragmentDaiPay.this);
