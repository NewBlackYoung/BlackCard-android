...
public class OtherCircleAdapter extends RecyclerView.Adapter<OtherCircleAdapter.ViewHolder> implements OnNetResultListener {
    private Context context;
    private List<OtherFindBean.DataBean.FindlistBean> list;

    public void setList(List<OtherFindBean.DataBean.FindlistBean> list) {
        this.list = list;
        notifyDataSetChanged();
    }

    public OtherCircleAdapter(Context context) {
