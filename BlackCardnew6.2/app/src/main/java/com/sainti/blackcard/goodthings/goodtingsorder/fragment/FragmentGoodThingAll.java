...
public class FragmentGoodThingAll extends BaseFragment implements OnNetResultListener, OnRefreshListener, OnLoadmoreListener, BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.OnItemChildClickListener, TimerListener, View.OnClickListener, CommenDialogUtil.CallBack {
    ...
    protected int setLayout() {
        return R.layout.fragment_goodthingsall;
    }
    ...
    public void onSuccessfulListener(String stringResult, int resultCode) {
        ...
        switch (resultCode) {
            ...
            case 4:
                WuLiuBean wuLiuBean = gson.fromJson(stringResult, WuLiuBean.class);
                Intent intents = new Intent(getContext(), WuliuWebViewActivity.class);
    ...
    public void onLoadmore(RefreshLayout refreshlayout) {
        page++;
        loadingView.dismiss();
        TurnClassHttp.haowuorder("all", String.valueOf(page), 2, context, this);
    }
    ...
    public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        String id = list.get(position).getOrder_id();
        switch (view.getId()) {
            case R.id.iv_goPay:
                if (state == 0) {
                    //代付款
                    ...
                    // 已发货iv_loo
                    TurnClassHttp.queryKd(id, 4, context, this);
                }else {
                    showDialog(position);
    ...
    private void poPya(int p) {
        ...
        intent.putExtra("money", ConvertUtil.doubleToString(money));
    ...
    public void onSureClick(int tpye) {
        TurnClassHttp.delhaowuorder(list.get(remov).getOrder_id(), 3, context, FragmentGoodThingAll.this);
        loadingView.show();
    }
