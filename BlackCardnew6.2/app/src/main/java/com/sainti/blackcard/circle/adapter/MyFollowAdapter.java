...
public class MyFollowAdapter extends RecyclerView.Adapter<MyFollowAdapter.ViewHolder> implements OnNetResultListener {
    ...
    public void setList(List<NewFindBean.DataBean.MyflowBean> list) {
        this.list = list;
