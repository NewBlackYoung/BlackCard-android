...
public class WuliuWebViewActivity extends BaseTitleActivity {
    ...
    private void getWebView() {
         ...
         * 设置js调用Android的接口
         */
        flxq_WebView.addJavascriptInterface(new WuliuWebViewActivity.JsInteration(), "control");
        /**
         * 提供网页加载各阶段的通 知
         * */
        flxq_WebView.setWebViewClient(new WuliuWebViewActivity.MyWebViewClient());
        /**
         * 提供网页加载过程中提供的数据内容
         * */
        flxq_WebView.setWebChromeClient(new WuliuWebViewActivity.MyWebChromeClient());
