...
public class CommonPopupWindow extends PopupWindow {
    ...
    public void showPopAtViewDown(View view) {
        controller.showPop(view);
       //controller.setBackGroundLevel(0.2f);
    }


    public void showPopAtPatentDown(View view) {
        controller.showPopAtPatentDown(view);
        controller.setBackGroundLevel(0.2f);
    }
    public void showPopAtPatentDown(View view,int height) {
        controller.showPopAtPatentDown(view,height);
        controller.setBackGroundLevel(0.2f);
    }
    public void disPop() {
        controller.disPop();
    ...
    public static class Builder {
        ...
        public CommonPopupWindow create() {
            ...
            CommontUtil.measureWidthAndHeight(popupWindow.controller.mPopupView);
            return popupWindow;
        }
    }
}
