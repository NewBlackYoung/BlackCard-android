...
import com.example.library.banner.layoutmanager.ScreenParamManager;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        if (mSelectedDrawable == null) {
            ...
            selectedGradientDrawable.setColor(context.getResources().getColor(R.color.e_eight));
      ...
      /*  int wight = screenParamManager.getScreenWidth()/2;
        MLog.d("pingmukuandu","屏幕宽度"+wight+"");*/
        int marginLeft = dp2px(0);
        int marginRight = dp2px(25);
        int marginBottom = dp2px(7);
        ...
        params.gravity = Gravity.RIGHT |Gravity.BOTTOM| gravity;
