...
import com.hyphenate.helpdesk.easeui.util.MLog;
...
public class MessageAdapter extends BaseAdapter {
    ...
    private static final int MESSAGE_TYPE_COUNT = 21;
    private static final int MESSAGE_TYPE_RECV_EvaluationMsg = 20;
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getType() == Message.Type.TXT) {
            switch (MessageHelper.getMessageExtType(message)) {
                case EvaluationMsg:
                    return MESSAGE_TYPE_RECV_EvaluationMsg;
        ...
        MLog.d("ppppppppppppppppppppppp", "typt-----------" + MessageHelper.getMessageExtType(message));
        return -1;// invalid
    }
    ...
    protected ChatRow createChatRow(Context context, Message message, int position) {
        ...
        switch (message.getType()) {
            case TXT:
                switch (MessageHelper.getMessageExtType(message)) {
                    case EvaluationMsg:
                        chatRow = new ChatRowEvaluation(context, message, position, this);
                        break;
                    case RobotMenuMsg:
        ...
        MLog.d("ppppppppppppppppppppppp", "typt2-----------" + MessageHelper.getMessageExtType(message));
        return chatRow;
    }
